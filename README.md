...
## 2️⃣ 주요 기술 및 아키텍처
- Java Swing을 활용한 GUI 기반의 애플리케이션 구현
- DAO 패턴을 사용한 데이터베이스 연동 및 SQL 쿼리 처리
- 서비스 계층을 통한 비즈니스 로직 분리 및 재사용성 향상
- 사용자 세션 관리 및 플레이리스트, 음악 검색 기능 구현
- 모듈화된 구조로 기능별 UI 컴포넌트 구성
- Main 클래스에서 애플리케이션의 전체 흐름 관리
