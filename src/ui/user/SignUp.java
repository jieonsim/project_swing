...
public class SignUp extends JFrame {
	...
	public SignUp() {
		...
		lblSplit1.setBounds(554, 444, 17, 15);
		panel2.add(lblSplit1);

		lblSplit2 = new JLabel("|");
		lblSplit2.setBounds(445, 444, 17, 15);
		...
		btnTryToLogin.setBounds(455, 439, 97, 23);
		...
		btnFindToPassword.setBounds(571, 439, 110, 23);
		...
		btnFindToID.setBounds(344, 439, 98, 23);
		...
		txtName.setBounds(334, 288, 340, 63);
		panel2.add(txtName);
		...
		txtPhoneNumber.setBounds(334, 361, 340, 63);
		...
		lblIPassword.setFont(new Font("AppleSDGothicNeoSB00", Font.PLAIN, 17));
		...
		passwordField.setBounds(334, 215, 340, 63);
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (success) {
					...
					JOptionPane.showMessageDialog(SignUp.this, "회원가입에 실패하였습니다. 입력 정보를 다시 확인해 주세요.");
					txtID.requestFocus();
				}
			}
		});
