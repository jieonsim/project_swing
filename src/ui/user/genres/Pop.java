...
public class Pop extends JFrame {
	private JButton btnHome, btnLogout, btnArtists, btnAlbums, btnSongs, btnAllPlaylists, btnFavoriteSongs,
			btnNewPlaylist, btnAddToFavoriteSongs, btnAddToMyPlaylist, btnExit;
	private JTextField txtSearch;
	private JLabel lblPlaylists, lblNewLabel, lblEssentialAlbums, lblNewReleaseArtistName1, lblNewReleaseArtistName2,
	...
	private JTable tableBestNewTracks;
	...
	public Pop() {
		...
		lblNewLabel = new JLabel("Best New Tracks > ");
		lblNewLabel.setFont(new Font("AppleSDGothicNeoM00", Font.PLAIN, 15));
		lblNewLabel.setBounds(23, 43, 204, 37);
		...
		tableBestNewTracks = new JTable();
		scrollPane.setViewportView(tableBestNewTracks);
