...
public class FindToID extends JFrame {
	...
	public FindToID() {
		...
		txtName.setBounds(334, 144, 340, 63);
		panel2.add(txtName);
		...
		btnFindToID.setBounds(398, 400, 211, 51);
		...
		lblPhoneNumber.setBounds(242, 234, 80, 51);
		...
		btnTryToLogin.setBounds(455, 320, 97, 23);
		...
		txtPhoneNumber.setBounds(333, 234, 340, 63);
		panel2.add(txtPhoneNumber);

		lblSplit1 = new JLabel("|");
		lblSplit1.setBounds(447, 325, 17, 15);
		...
		btnSignUp.setBounds(574, 320, 88, 23);
		panel2.add(btnSignUp);

		lblSplit2 = new JLabel("|");
		lblSplit2.setBounds(555, 325, 17, 15);
		...
		btnFindToID.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (foundUserId != null) {
					JOptionPane.showMessageDialog(null, "귀하의 아이디는 " + foundUserId + " 입니다.");
					dispose();
					new Login();
				} else {
