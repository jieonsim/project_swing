...
public class MyPlaylists extends JFrame {
	...
	public MyPlaylists() {
		...
		btnAddToCover.setIcon(new ImageIcon(MyPlaylists.class.getResource("/Images/picture.png")));
		...
		btnUpdatePlaylistName.setIcon(new ImageIcon(MyPlaylists.class.getResource("/Images/edit.png")));
