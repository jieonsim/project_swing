...
public class Pop2 extends JFrame {
	...
	public Pop2() {
		...
		lblNewReleases1.setIcon(new ImageIcon(Pop2.class.getResource("/Images/browse/popNew1.gif")));
		...
		lblNewReleases2.setIcon(new ImageIcon(Pop2.class.getResource("/Images/browse/popNew2.gif")));
