...
public class Jazz2 extends JFrame {
	...
	public Jazz2() {
		...
		lblNewReleases1.setIcon(new ImageIcon(Jazz2.class.getResource("/Images/browse/jazzNew1.gif")));
		...
		lblNewReleases2.setIcon(new ImageIcon(Jazz2.class.getResource("/Images/browse/jazzNew2.gif")));
		...
		JLabel lblNewReleaseAlbumName1 = new JLabel("Speak To Me");
		...
		lblNewReleaseArtistName1 = new JLabel("Julian Lage");
		...
		lblNewReleaseAlbumName2 = new JLabel("Elles");
		...
		lblNewReleaseArtistName2 = new JLabel("나윤선");
		...
		lblEssentialAlbum1.setIcon(new ImageIcon(Jazz2.class.getResource("/Images/browse/jazzEssential1.gif")));
		...
		lblEssentialAlbumName1 = new JLabel("Getz/Gilberto");
		...
		lblEssentialAlbumArtistName1 = new JLabel("Stan Getz & Joao Gilberto");
		...
		lblEssentialAlbum2.setIcon(new ImageIcon(Jazz2.class.getResource("/Images/browse/jazzEssential2.gif")));
		...
		lblEssentialAlbumName2 = new JLabel("Undercurrent");
		...
		lblEssentialAlbumArtistName2 = new JLabel("Bill Evans & Jim Hall");
