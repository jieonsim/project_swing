...
public class Rock2 extends JFrame {
	...
	public Rock2() {
		...
		lblAllTracks = new JLabel("Rock All Tracks > ");
		...
		lblNewReleases1.setIcon(new ImageIcon(Rock2.class.getResource("/Images/browse/rockNew1.gif")));
		...
		lblNewReleases2.setIcon(new ImageIcon(Rock2.class.getResource("/Images/browse/rockNew2.gif")));
		...
		JLabel lblNewReleaseAlbumName1 = new JLabel("B Sides and C Sides");
		...
		lblNewReleaseArtistName1 = new JLabel("Rancid");
		...
		lblNewReleaseAlbumName2 = new JLabel("Echo Dancing");
		...
		lblNewReleaseArtistName2 = new JLabel("Alejandro Escovedo");
		...
		lblEssentialAlbum1.setIcon(new ImageIcon(Rock2.class.getResource("/Images/browse/rockEssential1.gif")));
		...
		lblEssentialAlbumName1 = new JLabel("Nevermind");
		...
		lblEssentialAlbumArtistName1 = new JLabel("Nirvana");
		...
		lblEssentialAlbum2.setIcon(new ImageIcon(Rock2.class.getResource("/Images/browse/rockEssential2.gif")));
		...
		lblEssentialAlbumName2 = new JLabel("Highway To Hell");
		...
		lblEssentialAlbumArtistName2 = new JLabel("AC/DC");
		...
		Vector<Vector<Object>> data = musicService.getTracksByGenres("rock");
