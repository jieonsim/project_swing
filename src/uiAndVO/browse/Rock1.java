...
public class Rock1 extends JFrame {
	...
	public Rock1() {
		...
		lblNewReleases2.setIcon(new ImageIcon(Rock1.class.getResource("/Images/browse/rockNew1.gif")));
		...
		lblNewReleases3.setIcon(new ImageIcon(Rock1.class.getResource("/Images/browse/rockNew2.gif")));
		...
		JLabel lblNewReleaseAlbumName2 = new JLabel("B Sides and C sides");
		...
		lblNewReleaseArtistName2 = new JLabel("Rancid");
		...
		lblNewReleaseAlbumName3 = new JLabel("Echo Dancing");
		...
		lblNewReleaseArtistName3 = new JLabel("Alejandro Escovedo");
		...
		lblEssentialAlbum2.setIcon(new ImageIcon(Rock1.class.getResource("/Images/browse/rockEssential1.gif")));
		...
		lblEssentialAlbumName2 = new JLabel("Nevermind");
		...
		lblEssentialAlbumArtistName2 = new JLabel("Nirvana");
		...
		lblEssentialAlbum3.setIcon(new ImageIcon(Rock1.class.getResource("/Images/browse/rockEssential2.gif")));
		...
		lblEssentialAlbumName3 = new JLabel("Highway To Hell");
		...
		lblEssentialAlbumArtistName3 = new JLabel("AC/DC");
