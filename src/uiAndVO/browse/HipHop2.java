...
public class HipHop2 extends JFrame {
	...
	public HipHop2() {
		...
		lblAllTracks.setBounds(44, 38, 170, 27);
		...
		lblNewReleases1.setIcon(new ImageIcon(HipHop2.class.getResource("/Images/browse/hiphopNew1.gif")));
		...
		lblNewReleases2.setIcon(new ImageIcon(HipHop2.class.getResource("/Images/browse/hiphopNew2.gif")));
		...
		JLabel lblNewReleaseAlbumName1 = new JLabel("Don't Forget To Breathe");
		...
		lblNewReleaseArtistName1 = new JLabel("Buddy");
		...
		lblNewReleaseAlbumName2 = new JLabel("HAONOAH");
		...
		lblNewReleaseArtistName2 = new JLabel("hAON");
		...
		lblEssentialAlbum1.setIcon(new ImageIcon(HipHop2.class.getResource("/Images/browse/hiphopEssential1.gif")));
		...
		lblEssentialAlbumName1 = new JLabel("The Black Album");
		...
		lblEssentialAlbumArtistName1 = new JLabel("JAY-Z");
		...
		lblEssentialAlbum2.setIcon(new ImageIcon(HipHop2.class.getResource("/Images/browse/hiphopEssential2.gif")));
		...
		lblEssentialAlbumName2 = new JLabel("The Carter IV");
		...
		lblEssentialAlbumArtistName2 = new JLabel("Lil Wayne");
